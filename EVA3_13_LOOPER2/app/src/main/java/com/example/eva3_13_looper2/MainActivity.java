package com.example.eva3_13_looper2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.ejecutarTarea(new Runnable() {
            ...
            public void run() {
                ...
                Message message = handler.obtainMessage(100, "FIN DE HILO A");
                handler.sendMessage(message);
            }
            ...
            public void run() {
                ...
                Message message = handler.obtainMessage(100, "FIN DE HILO B");
                handler.sendMessage(message);
            }
        });
    }
